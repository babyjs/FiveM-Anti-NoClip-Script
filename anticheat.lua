...
local checkInterval = 2000 -- kontrol sıklığı (2 saniye)
local maxDistanceFromGround = 3.0 -- maksimum yerden yükseklik
local warningLimit = 3 -- banlanmadan önce kaç kez uyarılacağı

local playerWarnings = {}
local webhookURL = "BURAYA_WEBHOOK_URL_GIRIN" -- Discord webhook URL'nizi giriniz
